...
<div class="container container-payment bg-white rounded">
    ...
    <div class="wrapper">
        ...
        <div class="content">
            ...
            <div>
                {{__('payment.Address')}}
                <strong>468A Điện Biên Phủ, Tx Sapa, Lào Cai</strong>
            </div>
        </div>
    ...
    <div class="wrapper">
        ...
        <div class="content">
            {{__('payment.Bank')}} 
            <span>19020597711710</span><br>
            {{__('payment.Account Holder')}}
            <span>NGUYEN THI HUONG THAO</span>  <br>
            {{__('payment.Money')}} 
            *{{__('payment.Price')}}* <br>
            {{__('payment.Banking-content')}} 
            <span> THANHTOAN NGHIENGSAPA *{{__('payment.Receipt ID')}}*</span>
            <br>
        </div>
    </div>
